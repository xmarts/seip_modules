...
class OeHealthPatient(models.Model):
    ...
    seguro_social = fields.Selection([('1','Javier Mina'),('2','Pila Seca'),('3',' Federalismo')],string='UNIMEF')
    siseguro = fields.Boolean(string='¿Es derecho abiente IPEJAL?', help='Seleccionando esta opcion, se desplegara una opcion donde podras colocar tu numero de seguro, de ser lo contrario puedes continuar con los demas campos')
...
class OeHealthAppointment(models.Model):
    ...
    test_type = fields.Many2one('oeh.medical.labtest.types',string='Tipo de estudio',required=True)
